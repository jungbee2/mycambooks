        ...
        <View style={styles.menuContainer}>
          <View style={styles.menuBox}>
            <TouchableOpacity style={styles.backButton}>
              <Image
                source={require("../../assets/icon/mypage/notes.png")}
                style={styles.setImg}
              />
            ...
            <TouchableOpacity style={styles.backButton}>
              <Image
                source={require("../../assets/icon/mypage/wallet.png")}
                style={styles.setImg}
              />
            ...
            <TouchableOpacity style={styles.backButton}>
              <Image
                source={require("../../assets/icon/mypage/coins.png")}
                style={styles.setImg}
              />
            ...
            <TouchableOpacity style={styles.backButton}>
              <Image
                source={require("../../assets/icon/mypage/question.png")}
                style={styles.setImg}
              />
